...
// Component adapted from Reactbits ASCIIText (TS + Tailwind)
// https://reactbits.dev/r/ASCIIText-TS-TW
    ...
    >
      <style>{`
        ...
        .ascii-text-container pre {
          ...
          background-image: radial-gradient(circle, #ff6188 0%, #00ff88 50%, #ffd866 100%);
