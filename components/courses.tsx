...
const courses = [
  ...
  {
    id: 4,
    title: "Introdução à AWS: Da Nuvem ao Lambda",
  ...
  {
    id: 5,
    title: "Spring Boot na Prática: Construindo APIs que Voam",
  ...
  {
    id: 6,
    title: "Cybersegurança Essencial: Proteja-se no Mundo Digital",
